...
int	main(void) {
	std::set<char>	s1;
	std::set<char>	s2;
	std::pair<std::set<char>::iterator, std::set<char>::iterator>	p;
	std::pair<std::set<char>::iterator, bool>								p2;
	clock_t			start;
	clock_t			end;


	std::cout << std::endl << "=================== STD::SET TEST ===================" << std::endl << std::endl;
	...
	std::set<char>::iterator			it1 = s1.begin();
	std::set<char>::iterator			it2 = s1.end();
